...
function(n) {
    ...
    n.extend(n.validator, {
        defaults: {
            ...
            onkeyup: function(n, t) { (t.which !== 9 || this.elementValue(n) !== "") && (n.name in this.submitted || n === this.lastActive) && this.element(n)
            },
            onclick: function(n) {
        ...
        prototype: {
            ...
            check: function(t) {
                ...
                if (!e) return this.objectLength(f) && this.successList.push(t),
                !0
            },
